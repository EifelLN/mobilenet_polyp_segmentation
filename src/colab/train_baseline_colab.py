# ============================================================================
# POLYP SEGMENTATION - BASELINE TRAINING (GOOGLE COLAB VERSION)
# ============================================================================
# Single-file version of train_baseline.py for Google Colab.
# Trains Student model (MobileNetV2) with ground truth supervision only.
# ============================================================================
...
CONFIG = {
    ...
    "experiment_name": "MobileNetV2_Baseline_v1",
...
class PolypDataset(Dataset):
    ...
    def __init__(self, root_dir, transform=None, img_size=320):
        ...
        # Grab File Paths (sorted is mandatory for correct pairing!)
        ...
        if len(self.images_paths) == 0:
            raise ValueError(f"CRITICAL: No images found in {root_dir}/images. Check your path!")
        
        if len(self.images_paths) != len(self.masks_paths):
            raise ValueError(f"CRITICAL: Mismatch! Found {len(self.images_paths)} images but {len(self.masks_paths)} masks.")
